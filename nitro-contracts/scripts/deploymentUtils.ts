...
// EtherEver: removed Toolkit4844 import — we force reader4844=AddressZero, never need Reader4844 yul artifact
import {
  ArbOwner__factory,
...
export async function deployAllContracts(
  ...
  // EtherEver: no EIP-4844 support → force reader4844 to zero address regardless of isOnArb
  const reader4844 = ethers.constants.AddressZero
