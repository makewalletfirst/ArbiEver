  ...
  try {
    ...
    const deployParams = isDevDeployment
      ...
      : {
          ...
          // EtherEver: skip L2 factory deploys (CREATE2 proxies) — basefee=0 breaks
          // retryable submission fee calc. We can deploy these factories manually later
          // via direct L2 txs once the L2 is running.
    ...
    const createRollupTx = await rollupCreator.createRollup(deployParams, {
      value: 0, // no L2 factory deploys → no value needed
      gasLimit: 28000000,
    })
